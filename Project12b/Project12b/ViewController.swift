...
//  Project12b
//
//  Created by Helton Isac Torres Galindo on 29/08/20.
...
class ViewController: UICollectionViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    override func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        let person = people[indexPath.item]
        let ac = UIAlertController(title: "Choose An Action", message: "Do you want to rename or delete this person?", preferredStyle: .alert)
    ...
    func save() {
        ...
        if let saveData = try? jsonEnconder.encode(people) {
            let defaults = UserDefaults.standard
